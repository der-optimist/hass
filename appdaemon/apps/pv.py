...
#            self.log("Error running forecast at startup. Error was {}".format(e))
    ...
    def save_counter_values_at_midnight(self, kwargs):
        ...
        saved_money_by_selling_day = pv_sold_day * float(self.get_state(self.app_config["global_vars"]["input_number_entity_compensation_per_kwh"]))
        ...
        saved_money_by_consuming_day = (pv_produced_day - pv_sold_day) * float(self.get_state(self.app_config["global_vars"]["input_number_entity_price_per_kwh"]))
