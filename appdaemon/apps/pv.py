...
class pv(hass.Hass):
    ...
    def sensor_rest_forecast_changed(self, entity, attribute, old, new, kwargs):
        ...
        timestamps_daily.append(datetime.datetime.combine(day_0, datetime.time("12:00:00"),"%Y-%m-%dT%H:%M:%S.%f") + "Z")
        timestamps_daily.append(datetime.datetime.combine(day_1, datetime.time("12:00:00"),"%Y-%m-%dT%H:%M:%S.%f") + "Z")
        timestamps_daily.append(datetime.datetime.combine(day_2, datetime.time("12:00:00"),"%Y-%m-%dT%H:%M:%S.%f") + "Z")
        timestamps_daily.append(datetime.datetime.combine(day_3, datetime.time("12:00:00"),"%Y-%m-%dT%H:%M:%S.%f") + "Z")
        timestamps_daily.append(datetime.datetime.combine(day_4, datetime.time("12:00:00"),"%Y-%m-%dT%H:%M:%S.%f") + "Z")
        timestamps_daily.append(datetime.datetime.combine(day_5, datetime.time("12:00:00"),"%Y-%m-%dT%H:%M:%S.%f") + "Z")
