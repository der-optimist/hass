...
class save_reminders(hass.Hass):
    ...
    def initialize(self):
        self.set_textvalue("input_text.saved_reminder_001", "reminder_name", icon="/local/icons/reminders/exclamation_mark_blink.svg", friendly_name="Entkalkungsanlage: Salz kontrollieren")
