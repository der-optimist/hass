...
class garbage(hass.Hass):
    ...
    def initialize(self):
        ...
        self.switch_reminder_waste = "switch.reminder_restmuelltonne_erinnerung"
        self.switch_reminder_organic = "switch.reminder_biotonne_erinnerung"
        self.switch_reminder_paper = "switch.reminder_papiertonne_erinnerung"
        self.switch_reminder_plastic = "switch.reminder_raweg_erinnerung"
