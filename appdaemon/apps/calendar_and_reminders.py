...
class calendar_and_reminders(hass.Hass):
    ...
    def initialize(self):
        ...
        self.icon_birthday_today = "/local/icons/reminders/champagne_yellow_noblink.svg"
    ...
    def check_birthdays(self, kwargs):
        ...
        if _list == "error":
            ...
            del _list[4:] # limit to 4 birthdays
        ...
        if _list == "error":
            ...
            for element in _list:
                ...
                if event_start_dt >= last_minute_dt and event_start_dt < end_check_interval_dt:
                    ...
                    reminder_name = "switch.reminder_" + summary.replace(" ","").replace(".","").replace("!","").replace("?","").replace(".","").replace(":","").replace("-","").replace(",","").replace("/","")
